...
// 縮圖的支援
void MyDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改這段程式碼以繪製文件的資料
...
// 搜尋處理常式的支援
void MyDoc::InitializeSearchContent()
{
...
void MyDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
